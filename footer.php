...
<div class="footer_area">
        <div class="footer_shape">
          <img
            src="<?php echo $directory;?>/assets/img/footer/footerPattern.png"
            class="f-shape_one"
            alt=""
          />
          <img
            src="<?php echo $directory;?>/assets/img/footer/polygonFooter.png"
            class="f-shape_two"
            alt=""
          />
        </div>
        <div class="container">
          <div class="row">
            <div class="col-sm-7 col-md-6 col-lg-3 col-xl-4">
              <div class="footer_widget">
                ...
                <p class="footer_about_text">
                  Sed ut perspiciatis unde omnis iste natus error voluptatem Sed
                  ut perspiciatis unde omnis iste natus error voluptatem. Sed ut
                  perspiciatis
                </p>
                <div class="social_contact">
                  <a href="mailto: info@clippinglab24.com"
                    ><svg width="20.87" height="15">
                      <g
                        id="Mail_2"
                        data-name="Mail 2"
                        transform="translate(-163.667 -153.91)"
                      >
                        <path
                          id="dfdf"
                          data-name="Path 22"
                        ...
                        <path
                          ...
                          transform="translate(-1.391 -1.739)"
                          fill="#438ff9"
                        />
                        <path
                          id="sdfs"
                          ...
                          transform="translate(-7.652 -4.522)"
                          fill="#438ff9"
                        />
                        <path
                          id="Path_25"
                          ...
                          transform="translate(-1.391 -4.522)"
                          fill="#438ff9"
                        />
                      </g>
                    </svg>
                    <span
                      class="__cf_email__"
                      data-cfemail="5b32353d34753837322b3e291b3e363a323775383436"
                      >info@clippinglab24.com</span
                    ></a
                  >
                  <br />
                  <br />
                  <a href="tel:+8801821100600">
                    <svg
                      width="17.224"
                      height="17.224"
                    ...
                    >
                      <g id="dfde" transform="translate(-255.083 -150.41)">
                        ...
                        <path
                          ...
                          transform="translate(-6.529 -2.394)"
                          fill="#438ff9"
                        />
                        <path
                          id="fpokmd"
            ...
            <div class="col-sm-7 col-md-6 col-lg-3 col-xl-3 fixed_width">
                    ...
                    <a href="<?=site_url();?>"
                      ...
                      >
                        <path
                          id="dfdfd"
                          data-name="dfdfd"
                          d="M261.8,353l5.369,5.053-5.369,5.053"
                          transform="translate(-261.112 -352.271)"
                          fill="none"
                          stroke="rgba(43,27,154,0.55)"
            ...
            <div class="col-sm-7 col-md-6 col-lg-3 col-xl-2 fixed_width">
              <div class="widget_two">
                <h4>help</h4>
                <ul>
                  <li>
    ...
    ></script>
    <script src="<?php echo $directory;?>/assets/js/vendor/modernizr-3.5.0.min.js"></script>
    <script src="<?php echo $directory;?>/assets/js/vendor/jquery-v-3.6.0.0.min.js"></script>
    <script src="<?php echo $directory;?>/assets/js/bootstrap4.min.js"></script>
    <script src="<?php echo $directory;?>/assets/js/bootstrap.min.js"></script>
    <script src="<?php echo $directory;?>/assets/js/isotope.pkgd.min.js"></script>
    <script src="<?php echo $directory;?>/assets/js/jquery.meanmenu.min.js"></script>
    <script src="<?php echo $directory;?>/assets/js/wow.min.js"></script>
    <script src="<?php echo $directory;?>/assets/js/jquery.magnific-popup.min.js"></script>
    <script src="<?php echo $directory;?>/assets/js/slick.min.js"></script>
    <script src="<?php echo $directory;?>/assets/js/jquery.event.move.js"></script>
    <script src="<?php echo $directory;?>/assets/js/scriptfour.js"></script>
    <script src="<?php echo $directory;?>/assets/js/scriptSix.js"></script>
    <script src="<?php echo $directory;?>/assets/js/scriptseven.js"></script>
    <script src="<?php echo $directory;?>/assets/js/jquery.twentytwenty.js"></script>
    <script src="<?php echo $directory;?>/assets/js/jquery.lazy.min.js"></script>
    <script src="<?php echo $directory;?>/assets/js/scroll.js"></script>
    <script src="<?php echo $directory;?>/assets/js/multiple-image-video(MIV).js"></script>
    <script src="<?php echo $directory;?>/assets/js/preloader.js"></script>
